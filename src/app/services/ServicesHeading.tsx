...
const ServicesHeading = () => {
  return (
    <div className="bg-cover bg-center w-screen bg-no-repeat bg-fixed bg-[url(/assets/backgrounds/services.svg)]">
        <div className='mt-48 mb-24 md:mt-36 md:mb-36'>
            <h1 className='text-[4.8rem] w-11/12 text-center mx-auto text-[var(--heading-color)]'>What We Do</h1>
