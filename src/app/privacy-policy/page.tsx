...
const page = () => {
  return (
      ...
      <p className="italic text-[1.8rem]">
        ...
        to citizens and legal permanent residents of the European Economic Area
        and Switzerland.
      </p>
      <div className="my-5 space-y-2 text-[1.8rem]">
        <p>
          In this privacy statement, we explain what we do with the data we
          obtain about you via https://pixelrebellion.dev. We recommend you
          carefully read this statement. In our processing we comply with the
          requirements of privacy legislation. That means, among other things,
          that:
        </p>
        <ul className="ml-4 list-disc space-y-2 text-sm text-[1.2rem]">
          <li>
            We clearly state the purposes for which we process personal data. We
            do this by means of this privacy statement;
          </li>
          <li>
            We aim to limit our collection of personal data to only the personal
            data required for legitimate purposes;
          </li>
          <li>
            We first request your explicit consent to process your personal data
            in cases requiring your consent;
          </li>
          <li>
            We take appropriate security measures to protect your personal data
            and also require this from parties that process personal data on our
            behalf;
          </li>
          <li>
        ...
        <p className='text-[1.8rem]'>
          If you have any questions, or want to know exactly what data we keep
          of you, please contact us.
        </p>
      </div>
        ...
        <div className="space-y-2 text-base font-normal">
          ...
          <p>
            <a
              ...
              className="text-slate-750 font-normal underline"
            >
          ...
          <p>
            We retain this data upon termination of the service for the
            following number of months: 6 months
          </p>
        </div>
      </div>
      ...
      <div className="my-0 space-y-4 text-lg font-bold">
        ...
        <p className="space-y-2 text-base font-normal">
          ...
          manner. We recommend you read the privacy statements of these websites
      ...
      <ul className="ml-8 space-y-1 text-sm font-normal">
        ...
        <li>
          Website:{" "}
          <a href="https://pixelrebellion.dev" className="cursor-pointer">
            https://pixelrebellion.dev
          </a>
        </li>
        <li>
          Email:{" "}
