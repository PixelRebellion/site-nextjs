    ...
    <section className='flex flex-col items-center justify-start w-full h-full bg-[var(--background-color)]'>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full text-center md:text-left md:max-w-8/12 px-4 items-center mt-12 md:mt-36">
        <div className="bg-[var(--card-background)] p-6 rounded-lg shadow-md space-y-12">
          <h4 className="text-[1.8rem] md:text-[3.6rem] font-semibold text-[var(--primary-color)]">Creativity over conformity</h4>
          <h4 className="text-[1.8rem] md:text-[3.6rem] font-semibold text-[var(--primary-color)]">Quality over quantity</h4>
          <h4 className="text-[1.8rem] md:text-[3.6rem] font-semibold text-[var(--primary-color)]">Design with intent</h4>
          <h4 className="text-[1.8rem] md:text-[3.6rem] font-semibold text-[var(--primary-color)]">Build with purpose</h4>
        </div>
